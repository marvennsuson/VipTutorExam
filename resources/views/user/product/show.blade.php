...
@include('layouts.notification')
    <div class="container">
        <div class="col-lg-12">
            <form id="create_product" action="{{ route('user.product.update', $record["id"]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                <div class="row justify-content-start">
                    ...
                    <div class="col-sm-8 shadow ">
                        <div class=" p-3">
                            ...
                            <!-- Uploaded image area-->
                            <div class="image-area mt-4"><img id="imageResult" src="{{ !empty($record["image"]) && Route::is('user.product.show')  ? $record["fullpath"] . '/' . $record["image"]  : '#' }}" alt=""
