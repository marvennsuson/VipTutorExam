        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Record Data
                    <div class="float-end">
                        <a href="{{  route('user.product.create')  }}" class="btn btn-info">Create Product</a>
                    </div> 
                  </h4>
                                ...
                                <td class="align-middle">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                          <li><a href="{{route('user.product.show',['id' => $product->id ? $product->id : ''])}}" class="dropdown-item">Edit</a></li>
                                          <li> <a href="{{ route('user.product.destroy',['id' => $product->id ?  $product->id : '']) }}" class="dropdown-item">Delete</a>
                                           </li>
